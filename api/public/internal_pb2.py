...
_UPDATEUSERINPUTSET = _descriptor.Descriptor(
  name='UpdateUserInputSet',
  full_name='internal.UpdateUserInputSet',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='name', full_name='internal.UpdateUserInputSet.name', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='surname', full_name='internal.UpdateUserInputSet.surname', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='phoneNumber', full_name='internal.UpdateUserInputSet.phoneNumber', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='currentLocation', full_name='internal.UpdateUserInputSet.currentLocation', index=3,
      number=4, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_UPDATEUSERINPUT = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='set', full_name='internal.UpdateUserInput.set', index=1,
...
_UPDATEUSERINPUT.fields_by_name['set'].message_type = _UPDATEUSERINPUTSET
...
DESCRIPTOR.message_types_by_name['UpdateUserInputSet'] = _UPDATEUSERINPUTSET
...
UpdateUserInputSet = _reflection.GeneratedProtocolMessageType('UpdateUserInputSet', (_message.Message,), {
  'DESCRIPTOR' : _UPDATEUSERINPUTSET,
  '__module__' : 'internal_pb2'
  # @@protoc_insertion_point(class_scope:internal.UpdateUserInputSet)
  })
_sym_db.RegisterMessage(UpdateUserInputSet)
